...
@section('pages_detail','Danh sách Thương hiệu')

@section('content')
<div class="container-fluid py-4">
    <div class="row">
        <div class="col-12">
            <a href="{{route('brand.create')}}" class="btn btn-icon btn-3 btn-primary" type="button">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                              <div class="d-flex px-2 py-1">
                                ...
                                <div class=" justify-content-center">
                                  <h4 class="mb-2 text-mb ">{{$brand->brand_name}}</h4>
                            ...
                            <td class="align-middle  text-center mr-5">
                              <a href={{route('brand.edit',$brand->brand_id)}} class="btn btn-outline-secondary " data-toggle="tooltip" >
                                Sửa
                              </a>
                              <form 
                              action="{{route('brand.delete',$brand->brand_id)}} "
                              method="POST"
                              >
                              @method('DELETE')
                              @csrf
